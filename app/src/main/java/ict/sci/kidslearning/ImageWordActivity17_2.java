...
public class ImageWordActivity17_2 extends AppCompatActivity {
...
//	};
	...
	public void next(View v){
		...
		if(i<=imageArray.length-2){
			...
			Intent img = new Intent(ImageWordActivity17_2.this, WordListActivity2016_1_5.class);
			   startActivity(img);
			this.finish();
		}
