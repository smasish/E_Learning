...
public class QuestionActivity2016_3 extends AppCompatActivity {
    ...
    private int[] imageArray = {
            R.drawable.a32,R.drawable.a33,R.drawable.a4,R.drawable.a48,R.drawable.a7,
            R.drawable.a15,R.drawable.a37,R.drawable.a21,R.drawable.a17,R.drawable.a25,
            R.drawable.a20,R.drawable.a49,R.drawable.a18,R.drawable.a35,R.drawable.a14,
            R.drawable.a29,R.drawable.a6,R.drawable.a16,R.drawable.a40, R.drawable.a10,
            R.drawable.a39,R.drawable.a46,R.drawable.a23,R.drawable.a12,R.drawable.a31,
            R.drawable.a19,R.drawable.a27,R.drawable.a9,R.drawable.a36,R.drawable.a5,
       ...
       // for(int i=indexArray;i<imageArray.length;i+=6){
        ...
        if(i<imageArray.length-6){
           ...
           // Intent img = new Intent(QuestionActivity.this, AboutActivity.class);
            Intent img = new Intent(QuestionActivity2016_3.this, WordListActivity2016_3.class);
            startActivity(img);
            this.finish();
        }
